...
final class QTMediaBoxTests: XCTestCase {
    ...
    func testExample() throws {
        ...
        let mediaBox = try testData?.parseForBox(offset: 326)

        XCTAssertEqual(mediaBox?.type, .mdia)
        
        XCTAssertEqual(mediaBox?.location, 326..<5507)
    }
